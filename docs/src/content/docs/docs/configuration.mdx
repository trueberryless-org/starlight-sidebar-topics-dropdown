---
title: Configuration
description: An overview of the configuration options supported by the Starlight Multiple Sidebar Dropdown plugin.
---

The Starlight Multiple Sidebar Dropdown can be configured inside the `astro.config.mjs` configuration file of your project:
...
The Starlight Multiple Sidebar Dropdown plugin accepts an array of topics to display in the sidebar.
