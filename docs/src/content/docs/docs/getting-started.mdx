...
1. Starlight Multiple Sidebar Dropdown is a Starlight [plugin](https://starlight.astro.build/reference/plugins/). Install it using your favorite package manager:
...
The Starlight Multiple Sidebar Dropdown plugin behavior can be tweaked using various [topic configuration options](/docs/configuration/#topic-configuration).
